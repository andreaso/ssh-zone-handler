...
install --owner=root --group=root --mode=0644 /mp/devel/named/named.conf.options /mp/devel/named/named.conf.local /etc/bind/

rm /etc/systemd/system/named.service
systemctl enable --now primary.service named.service
